...
public final class BroadcastSender {
    ...
    public static void sendPlayAllAction(Context context) {
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(ACTION_PLAY_ALL));
    }

    public static void sendStopAllAction(Context context) {
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(ACTION_STOP_ALL));
    }
    ...
    public static void sendSetRouterAction(Context context){
        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(ACTION_SET_ROUTER));
    }
